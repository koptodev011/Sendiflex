            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1 me-5">
                            ...
                            <div style="margin-left: 60px;" class="totalpayment">
                                <h1>Total Earning={{$totalpayment->total_payment}}</h1>
                            </div>
                        </div>
                        <!--end::Search-->
                    </div>
                    <div class="card-toolbar">
                        ...
                        <form action="/viewexpence" method="get">
                            <input type="hidden" name="id" value="{{ request()->query('id') }}">
                            <button type="sumbit" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form method="POST" id="kt_modal_add_user_form" class="form needs-validation" action="/totalpayment"
                                                        ...
                                                        <div class="form-col">
                                                            <div class="fv-row mb-7">
                                                                <label class="required fw-bold fs-6 mb-2">Area of
                                                                    Earning</label>
                                                                <input type="text" name="area-of-earning[]"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-1250px">Earning Resource</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $user->earning_resource }}</div>
                                </td>
            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" name="area-of-earning[]" class="form-control form-control-solid mb-3 mb-lg-0" required />
