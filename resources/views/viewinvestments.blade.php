                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <h2 class="fw-bolder">Add Investment</h2>
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form method="POST" id="kt_modal_add_user_form" class="form needs-validation"
                                            action="/addinvestment" enctype="multipart/form-data" novalidate>
                                            @csrf
                                            ...
                                            <div id="form-container" class="form-container">
                                                <div class="form-group">
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Investment
                                                            Area</label>
                                                        <input type="text" name="investmenttitle"
                                                            class="form-control form-control-solid mb-3" required />
                                                        <div class="invalid-feedback">Please provide a valid area of
                                                            earning.</div>
                                                    </div>

                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Rate of
                                                            Interest</label>
                                                        <input type="number" name="rateofinterest"
                                                            class="form-control form-control-solid mb-3" required />
                                                        <div class="invalid-feedback">Please provide a valid rate of
                                                            interest.</div>
                                                    </div>

                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Period of Time</label>
                                                        <select name="period"
                                                            class="form-control form-control-solid mb-3" required>
                                                        ...
                                                        <div class="invalid-feedback">Please select a valid period.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="number" name="amount"
                                                            class="form-control form-control-solid mb-3" min="0"
                                                            required />
                                                        <div class="invalid-feedback">Please provide a valid amount.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-1250px">Investment Area</th>
                                <th class="min-w-120px">Rate of interest</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $user->investment_area }}</div>
                                </td>
                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $user->rate_of_interest }}</div>
                                </td>

                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $user->duration }}</div>
                                </td>
                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $user->amount }}</div>
                                </td>
